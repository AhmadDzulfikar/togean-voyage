...
export const blogPosts: BlogPost[] = [
    {
        ...
        heroImage: "/blog/village-visit-etiquette/hero.png",
        locationLabel: "Togean",
        date: "Mar 10, 2026",
        category: "Journal",
        excerpt: "Experience the warmth of the Bajau people. This guide outlines the cultural dos and don’ts when visiting local villages, ensuring your interactions are respectful, meaningful, and unforgettable.",
        content: `
Let’s be honest. You did not travel all the way to Central Sulawesi just to stare at the ceiling of your hotel room. You came here for the crystal-clear water, the jungles, and most importantly, the people.

Visiting the local villages is often the highlight of a trip to the Togeans and Luwuk. This is especially true for the Bajau "Sea Gypsy" settlements built on stilts over the water. But entering a village is like entering someone’s living room. To help you navigate the culture gap without awkwardness, here is your survival guide to being a culturally conscious traveler.

### 1. The "Tropical Modest" Dress Code
We know it is hot and we know you have a great swimsuit. But when you step off the boat and onto the village jetty, it is time to cover up a little.
- The Vibe: Togean and Luwuk communities are generally conservative. Walking around in a bikini or shirtless is a major mistake in the villages.
- The Fix: Keep a sarong or a light t-shirt handy. Covering your shoulders and knees shows a lot of respect. Think "relaxed exploration" instead of "beach party."

### 2. The Power of a Smile
In Indonesia, a smile is the universal language.
- The Vibe: If you walk past locals with a stone face, they might think you are angry or arrogant.
- The Fix: Smile often! It breaks the ice instantly. Learn a simple phrase like "Apa kabar?" (How are you?) or just a friendly "Halo!" You will likely be greeted by a chorus of excited kids shouting "Hello Mister!" or "Hello Miss!" so wave back as it is part of the fun.

### 3. The Camera Etiquette: Ask First
The Bajau villages are incredibly photogenic and the kids are adorable. However, these are real homes rather than exhibits.
- The Rule: Always ask for permission before taking close-up portraits of adults or inside their homes. A simple gesture of pointing to your camera and raising your eyebrows with a smile usually does the trick.
- Pro Tip: Put the camera down for the first 10 minutes. Chat or mime to interact and connect first. The photos will be much better when there is a genuine connection behind them.

[[IMAGE_VILLAGE]]

### 4. The Right Hand Rule
This is a classic Indonesian custom.
- The Rule: The left hand is traditionally considered "unclean" because it is historically used for bathroom duties.
- The Fix: Always use your right hand to give or receive money, food, or handshakes. If you are left-handed, do not panic. Just try your best to remember!

[[IMAGE_OCEAN]]

### How to Support Local Communities
You want your visit to leave a positive impact. Here is how you can directly support the families you meet:

Buy Local Products:
If you see locals selling handmade crafts, coconut oil, or snacks, buy from them! It puts cash directly into the household economy. Even buying a fresh coconut helps.

Be a Zero-Waste Warrior:
Remote islands struggle with plastic waste.
- Don't: Leave your snack wrappers or empty bottles behind.
- Do: Bring your own reusable water bottle. If you buy a snack in the village, take the wrapper back to your resort or a proper disposal area on the mainland. The locals will appreciate you keeping their ocean backyard clean.

Hire Local Guides:
Whether it is a boat trip to jellyfish lake or a hike in Luwuk, try to hire local guides. They might not speak perfect English, but they know the secrets of the land that Google Maps lacks. Plus, it encourages the community to protect their natural resources for tourism.
