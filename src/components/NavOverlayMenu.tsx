...
export default function NavOverlayMenu({ isOpen, onClose }: NavOverlayMenuProps) {
    ...
    return (
        ...
        >
            ...
            {/* Main Content Area */}
            <div className="flex-1 flex flex-col justify-center items-center overflow-y-auto w-full h-full pt-16 pb-10">
                {/* Menu List */}
                <nav className="flex flex-col items-center gap-4 md:gap-6">
                    {MENU_ITEMS.map((item) => (
                        ...
                        >
                            <span className="font-canto text-[42px] md:text-[64px] leading-[1.1] text-center transition-opacity duration-300">
                                {item.label}
                            </span>

                            {/* Hover Arrow Wrapper */}
                            <span className="absolute left-full ml-4 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 ease-out flex items-center">
                                {/* ChevronRight Icon */}
                ...
                {/* Social Icons */}
                <div className="mt-12 md:mt-16 flex items-center gap-5 md:gap-8">
                    {/* WhatsApp */}
                    <a
